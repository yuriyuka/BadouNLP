...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("哪个系统包含Coinpusher")
    print(res)
    res = graph.query("Piggy的主要购买人群是谁")
    print(res)
    res = graph.query("Piggy的pidtype是什么")
    print(res)
    res = graph.query("Coinpusher的pidclass是什么")
    print(res)
    res = graph.query("Piggy的中文名称")
    print(res)
    res = graph.query("coins和B级是什么关系")
    print(res)
