...
embeddings_layer_norm_weight_count=768
...
v_b_count=1
o_b_count=1
attention_layer_norm_w_count=768
attention_layer_norm_b_count=1
num_layers = 12
intermediate_size=3072
ff_layer_norm_w_count=768
...
FFN_weight_counts=hidden_size*intermediate_size+intermediate_size+intermediate_size*hidden_size+hidden_size+ff_layer_norm_w_count*hidden_size+ff_layer_norm_b_count*hidden_size
