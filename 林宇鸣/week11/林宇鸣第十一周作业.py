...
class LanguageModel(nn.Module):
    def __init__(self, hidden_size, vocab_size, pretrain_model_path):
        ...
        self.bert = BertModel.from_pretrained(r"D:\codeLearning\code\badouweek6\bert-base-chinese", return_dict=False, attn_implementation='eager')
...
if __name__ == "__main__":
    ...
    train(r"D:\codeLearning\code\badouweek10\transformers-生成文章标题\sample_data.json", False)
