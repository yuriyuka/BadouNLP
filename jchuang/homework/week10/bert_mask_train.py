...
class LanguageModel(nn.Module):
    def __init__(self, input_dim, vocab):
        ...
        self.layer = BertModel.from_pretrained(r'D:\python\resources\workspace\bert-base-chinese',
...
def build_sample(vocab, window_size, corpus):
    ...
    tokenizer = BertTokenizer.from_pretrained(r'D:\python\resources\workspace\bert-base-chinese')
...
def generate_sentence(openings, model, vocab, window_size):
    ...
    with torch.no_grad():
        ...
        while pred_char != '\n' and len(openings) <= 30:
            openings += pred_char
            x = BertTokenizer.from_pretrained(r'D:\python\resources\workspace\bert-base-chinese').encode(
            ...
            pred_char = BertTokenizer.from_pretrained(r'D:\python\resources\workspace\bert-base-chinese').decode(
                index)
    return openings
...
def train(corpus_path, save_weight=True):
    ...
    vocab = build_vocab(r'D:\python\resources\workspace\bert-base-chinese/vocab.txt')  # 建立字表
...
if __name__ == '__main__':
    ...
    train('./category_corpus/corpus.txt', False)
