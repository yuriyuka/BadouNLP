...
def train():
    ...
    _, train_x, train_y = dataGenerator.make_datas(dataGenerator.generator_a_pos_data, input_size, train_data_num)
    _, evaluate_x, evaluate_y = dataGenerator.make_datas(dataGenerator.generator_a_pos_data,
