...
class LanguageModel(nn.Module):
    ...
    def forward(self, x, y=None):
        ...
        if y is not None:
            ...
            x = self.bert(input_ids=x, attention_mask=generate_square_subsequent_mask(self.config["batch_size"] , self.config["window_size"]))[0]  # output shape:(batch_size, sen_len, hidden_size )
