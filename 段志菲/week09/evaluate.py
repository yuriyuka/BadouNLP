...
class Evaluator:
    ...
    def decode(self, sentence, labels):
        # 由于BERT tokenizer会将词拆分为子词，我们需要将标签对齐到原始文本
        tokens = self.tokenizer.tokenize(sentence)
        word_ids = self.tokenizer(sentence, is_split_into_words=True).word_ids()
        ...
        labels_str = "".join([str(x) for x in aligned_labels])
