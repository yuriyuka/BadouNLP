...
class GraphQA:
    def __init__(self):
        self.graph = Graph("http://localhost:7474", auth=("neo4j", "demo1"))
...
if __name__ == "__main__":
    ...
    # print(res)
    res = graph.query("刘亦菲的别名是什么呢")
    print(res)
    res = graph.query("刘亦菲的故乡是哪里")
    print(res)
    res = graph.query("段奕宏的爱好是什么")
    print(res)
    res = graph.query("刘亦菲的代表作品")
    print(res)
    res = graph.query("仙女姐姐和刘亦菲是什么关系")
    print(res)
