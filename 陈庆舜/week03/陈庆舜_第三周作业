...
class TorchModel(nn.Module):
    def __init__(self, vector_dim, out_size, sen_len, vocab):
        ...
        self.rnn = nn.RNN(vector_dim, hidden_size=128, batch_first=True, num_layers=2, dropout=0.5) # 输入的向量维度为vector_dim 隐藏层的维度为hidden_size batch_first=True表示张量形状为(batch_size, sen_len, vector_dim)
...
if __name__ == "__main__":
    main()
    test_strings = ["wqeqra", "daferw", "aaqbbt", "sda你sa"]
