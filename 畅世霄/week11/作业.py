...
class LanguageModel(nn.Module):
    def __init__(self, weight, vocab):
        ...
        self.bert = BertModel.from_pretrained(r"E:\PycharmProjects\NLPtask\week11大模型相关第一讲\bert-base-chinese")
...
#加载字表
def build_vocab():
    bert_vocab = BertTokenizer.from_pretrained(r"E:\PycharmProjects\NLPtask\week11大模型相关第一讲\bert-base-chinese").vocab
    return bert_vocab
...
def train(corpus_path, save_weight=True):
    ...
    for epoch in range(epoch_num):
        ...
        print(generate_sentence("厦门公交车纵火案遇难者名单公布", model,vocab, window_size))
    if not save_weight:
        return
    else:
        model_path = r"E:\PycharmProjects\NLPtask\week11大模型相关第一讲\bert-base-chinese"
