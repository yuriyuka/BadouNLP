...
def train(corpus_path, save_weight=True):
    ...
    pretrain_model_path = r'G:\MINE\NLP课件\WangLT\006第六周 语言模型\bert-base-chinese'
...
if __name__ == "__main__":
    train(r"G:\MINE\NLP课件\WangLT\010第十周 文本生成\week10 文本生成问题\lstm语言模型生成文本\corpus.txt", False)
