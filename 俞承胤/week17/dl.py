...
class DialogueSystem:
    ...
    def intent_judge(self, memory):
        ...
        print(hit_node.endswith("node5"))
        # if max_score<0.1:
        #     memory = {"available_nodes":["scenario-买衣服_node1","scenario-买衣服_node5"]}
        #     memory["hit_node"] = ""
        # else:
            # if hit_node.endswith("node5"):
            #     pass
            # else:
    ...
    def run(self, query, memory):
        ...
        '''
        memory["query"] = query
        score = self.calucate_node_score(query, "scenario-买衣服_node5")
        if score <= 0:
...
if __name__ == '__main__':
    ...
    memory = {"available_nodes":["scenario-买衣服_node1","scenario-买衣服_node5"]} #用户状态
    print(memory)
    while True:
        query = input("请输入：")
        # query = "你好"
