...
class GraphQA:
    def __init__(self):
        self.graph = Graph("http://localhost:7575", auth=("neo4j", "neo4j123"))
...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("谁导演的雪山飞狐")
    print(res)
    res = graph.query("金庸的真实姓名是什么")
    print(res)
    res = graph.query("鹿鼎记的制片人是谁")
    print(res)
    res = graph.query("金庸的籍贯是哪里")
    print(res)
    res = graph.query("白马啸西风的作者是谁")
    print(res)
