...
from loader import  bert_load_data
...
class Evaluator:
    def __init__(self, config, model, logger):
        ...
        self.model = model
        self.logger = logger
        self.valid_data = bert_load_data(config["valid_data_path"], config, shuffle=False)
    ...
    def write_stats(self, labels, pred_results, sentences):
        print(len(labels) , len(pred_results) , len(sentences))
