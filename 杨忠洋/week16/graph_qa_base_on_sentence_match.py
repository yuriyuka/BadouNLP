...
class GraphQA:
    def __init__(self):
        self.graph = Graph("bolt://127.0.0.1:7687", user="neo4j", password="yzyzzz999", name="neo4j")
...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("邓紫棋的歌曲光年之外发行时间")
    print(res)
    # 预期输出：2015年8月21日
    res = graph.query("邓紫棋的代表作品")
    print(res)
    # 预期输出：泡沫、光年之外、来自天堂的魔鬼
