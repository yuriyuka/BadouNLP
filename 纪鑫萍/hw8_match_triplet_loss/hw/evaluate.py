...
class Evaluator:
    def __init__(self, config, model, logger):
        ...
        # ‼️事实上可以通过传参把前面加载的训练集传进来更合理，但是为了主流程代码改动量小，在这里重新加载一遍
    ...
    def knwb_to_vector(self):
        self.question_index_to_standard_question_index = {}  # 问题编号到标准问题标号的映射
        self.question_ids = []  # 标准问题对应的所有问题编号
        for standard_question_index, question_ids in self.train_data.dataset.knwb.items():  # ==> target问题 对 相关问题编号
