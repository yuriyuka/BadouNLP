...
def main(corpus_path, save_weight=False):
    epoch_num = 200
    batch_size = 512
    char_dim = 768
    max_length = 50
    ...
    pretrain_model_path = r'N:\八斗\上一期\bert-base-chinese'
    ...
    for epoch in range(epoch_num):
        ...
        print(generate_sentence("留学：不妨向“过来人”打听“情报”（图）", model, tokenizer))
        print(generate_sentence("逃犯看奥运会比赛大喊“好球”暴露", model, tokenizer))
    if not save_weight:
        return
    else:
...
if __name__ == "__main__":
    ...
    main(r"N:\八斗\上一期\第七周 文本分类\week7 文本分类问题\data\train_tag_news.json", False)
