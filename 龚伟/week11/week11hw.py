...
class LanguageModel(nn.Module):
    def __init__(self, hidden_size, vocab_size, pretrain_model_path):
        ...
        self.bert = BertModel.from_pretrained(r"E:\八斗\第六周 语言模型\bert-base-chinese\bert-base-chinese", return_dict=False, attn_implementation='eager')
...
if __name__ == "__main__":
    ...
    train(r"/Users/wayne/PycharmProjects/week11/sample_data.json", False)