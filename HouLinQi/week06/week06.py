...
model = BertModel.from_pretrained(r"D:\WorkSpace\NLP\pythonTest\bert-base-chinese\bert-base-chinese",return_dict=False)
n = 2
vocab = 21128
...
all_parameters = embedding_parameters + (self_attention_parameters + self_attention_out_parameters + \
