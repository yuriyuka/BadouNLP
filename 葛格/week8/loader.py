...
class DataGenerator:
    ...
    # 生成3元祖，anchor，positive，negative
    def random_train_sample(self):
        ...
        # anchor和positive都必须来自同一个类别
        anchor, positive = random.sample(self.knwb[anchor_label], 2)

        # positive必须来自不同类别
        negative_label = random.choice([x for x in standard_question_index if x != anchor_label])
...
if __name__ == "__main__":
    ...
    dg = DataGenerator("/Users/ge/PycharmProjects/pythonProject/bd/week08/data/train.json", Config)
    print(dg[1])
