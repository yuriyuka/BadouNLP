...
model = BertForMaskedLM.from_pretrained(r'E:\BaiduNetdiskDownload\bert-base-chinese')
tokenizer = BertTokenizer.from_pretrained(r'E:\BaiduNetdiskDownload\bert-base-chinese')
...
class LanguageModel(nn.Module):
    ...
    def forward(self, x, y=None):
        # 将输入转换为BERT所需的输入格式
        inputs = {'input_ids': x, 'attention_mask': (x != self.tokenizer.pad_token_id).long()}
