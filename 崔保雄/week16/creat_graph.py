...
class GraphQA:
    def __init__(self):
        ...
        schema_path = "kg_schema_2.json"
        templet_path = "question_templet_2.xlsx"
...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("搬马机器人的供能是什么")
    print(res)

    res = graph.query("XCD021的操作类型是什么")
    print(res)

    res = graph.query("CQD18S2的额定载荷是多少")
    print(res)

    res = graph.query("XCD101和搬马机器人是什么关系")
    print(res)
