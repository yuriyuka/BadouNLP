...
class TorchModel(nn.Module):
    ...
    def forward(self, x, target=None):
        sequence_output, pooler_output = self.bert(x)      #input shape:(batch_size, sen_len, hidden_size)  output shape: (batch_size, sen_len, hidden_size) (batch_size, hidden_size)
